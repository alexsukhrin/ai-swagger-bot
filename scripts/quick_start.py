...
def demo_simple_agent():
    ...
    try:
        ...
        agent = SimpleSwaggerAgent("examples/swagger_specs/shop_api.json", enable_api_calls=False)
...
def demo_endpoints():
    ...
    try:
        ...
        for i, endpoint in enumerate(endpoints[:5], 1):  # Показуємо перші 5
            ...
            # Кольори для методів
            method_colors = {"GET": "🟢", "POST": "🔵", "PUT": "🟡", "DELETE": "🔴", "PATCH": "🟠"}
...
def show_usage_examples():
    ...
    examples = {
        ...
        "Streamlit інтерфейс": ["streamlit run enhanced_chat_app.py"],
        "Python код": [
