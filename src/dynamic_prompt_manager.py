...
class DynamicPromptManager:
    ...
    def record_usage(
        self, prompt_id: int, user_query: str, context: str, result: str, success: bool
    ):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            cursor.execute(
                ...
                VALUES (?, ?, ?, ?, ?, ?)
            """,
                (prompt_id, user_query, context, result, success, datetime.now().isoformat()),
            )
    ...
    def add_prompt_from_user(
        self, user_query: str, prompt_text: str, category: str = "user_defined"
    ) -> int:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            categories = [
                {"category": row[0], "count": row[1], "avg_success": row[2]}
